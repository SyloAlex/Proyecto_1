...
public class FoodList {
    ...
    public void addFirst(String food){
    ...
    public void addLast(String food){
        FoodNode newNode = new FoodNode(food);
        if (isEmpty()){
            addEmpty(food);
        }else{
    ...
    public void addEmpty(String food){
        FoodNode newNode = new FoodNode(food);
        first = newNode;
        last = newNode;
        size = size + 1;
    ...
    public void addNode(String food, int position){
        FoodNode newNode = new FoodNode(food);
        if (isEmpty()){
            addEmpty(food);
        }else{
    ...
    public void addPostPosition(String food, int position){
